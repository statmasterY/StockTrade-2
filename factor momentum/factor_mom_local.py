...
factordata_df = pd.read_csv("C:\\Users\\86191\\Desktop\\量化实习代码\\ALL_factorValues_2021-2023.csv") #做了修改调整
...
def get_weight_stock_final(factpr_df,stock_weight,factor_weight,method_factor='long',quantile=5):
    ...
    df = pd.concat([df.reindex(weight_s.index),weight_s],axis=1).dropna(how = 'all') ###做了修改
...
path = r'D:\杨钦\计算机语言与笔记\quant\牧鑫\res\\' ##待修改
